...
def ensure_claude_reference() -> None:
    ensure_file_exists(AGENTS, "canonical AGENTS.md")
    ensure_file_exists(CLAUDE, "Claude compatibility file")
    content = CLAUDE.read_text(encoding="utf-8")
    if "AGENTS.md" not in content:
        fail("CLAUDE.md must point readers to AGENTS.md")
